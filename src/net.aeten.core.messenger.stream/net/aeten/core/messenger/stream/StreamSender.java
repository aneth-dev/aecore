...
public class StreamSender<Message> extends Sender.SenderAdapter<Message> {
	...
	public void send(MessengerEventData<Message> data) throws IOException {
		...
		if (objectOutputStream == null) { throw new IOException("Stream is closed"); }
	...
	protected void doConnect() throws IOException {
		if (initalizer == null && outputStream == null) { throw new IOException("Unable to re-open output stream " + identifier); }
