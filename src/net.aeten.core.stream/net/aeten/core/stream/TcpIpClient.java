...
public class TcpIpClient {
	...
	private TcpIpClient(InetSocketAddress destination, boolean bind, boolean reuse, int timeout) throws IOException {
	...
	static TcpIpClient get(InetSocketAddress destination, boolean bind, boolean reuse, int timeout) throws IOException {
	...
	public static class InputStream extends java.io.InputStream {
		...
		public InputStream(InetSocketAddress destination, boolean bind, boolean reuse, int timeout) throws IOException {
	...
	public static class OutputStream extends java.io.OutputStream {
		...
		public OutputStream(InetSocketAddress destination, boolean bind, boolean reuse, int timeout) throws IOException {
